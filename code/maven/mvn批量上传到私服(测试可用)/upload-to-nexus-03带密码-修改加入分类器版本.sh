...
# 要修改的地方
# 配置参数：私服地址和认证ID
NEXUS_USERNAME="admin"          # 替换为实际用户名
NEXUS_PASSWORD="admin123"          # 替换为实际密码
# 10.31.65.111:8081/repository/maven-releases/处换为实际地址
NEXUS_URL="http://${NEXUS_USERNAME}:${NEXUS_PASSWORD}@10.31.65.111:8081/repository/maven-releases/"
